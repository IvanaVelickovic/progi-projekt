...
interface ProfileLayoutProps {
  activeTab: "personal" | "expertise" | "biography";
  setActiveTab: (tab: "personal" | "expertise" | "biography") => void;
  children: React.ReactNode;
}

const ProfileLayoutInstructor = ({
  activeTab,
  setActiveTab,
  children,
}: ProfileLayoutProps) => {
    ...
    <>
      ...
      >
        ...
        <div className="bg-white rounded-md p-6 shadow-sm flex flex-col items-center">
          ...
          />
          <p className="text-lg text-[#1e3a56] font-semibold">Instruktor</p>
        </div>
      </div>
...
export default ProfileLayoutInstructor;
